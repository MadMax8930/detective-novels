    ...
    <div className="flex flex-col gap-2 pt-24 text-center">
      ...
      <div className="donations-container">
         <Link href={COFFEE_URL} passHref target="_blank" rel="noopener noreferrer">
            <Button title="Buy me a coffee" reactIcon={<SiBuymeacoffee size={20} />} additionalStyles="button-donate" />
         </Link>
         <Link href={PAYPAL_URL} passHref target="_blank" rel="noopener noreferrer">
            <Button title="Support my work" reactIcon={<FaPaypal size={20} />} additionalStyles="button-donate" />
         </Link>
      </div>
    </div>
  );
