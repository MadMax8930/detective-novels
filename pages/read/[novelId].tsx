...
const Read = () => {
   ...
   return (
      <div className="w-screen bg-primary-dark">
         {/* Top Navigation */}
         <div className="fixed w-full px-6 md:px-24 z-10 flex flex-col justify-between gap-1 bg-primary-black bg-opacity-80">
         ...
         <div className="md:pt-32 pt-20 px-6 md:px-36 text-justify">
            ...
            <div className="preview-info">
               <p className="text-primary-lighter text-sm md:text-2xl uppercase">To Read the rest of this novel,&nbsp;<br className="sm:hidden"/>
